abstract type AbstractPhalcon <: ProgramIterator end
...
@programiterator mutable Phalcon(
    problem = nothing,
...
function heuristic_cost(iter::Phalcon, program::AbstractRuleNode)::Number
...
"""
function add_to_pool!(iter::Phalcon, program::AbstractRuleNode, parent=nothing)    
...
"""
function initialize!(iter::Phalcon)
    # ---------------------------
    #   1. Setup fields
    # ---------------------------
...
function refine_heuristic!(iter::Phalcon)
...
"""
function Base.iterate(iter::Phalcon)
    initialize!(iter)
...
"""
function Base.iterate(iter::Phalcon, state::Vector{<:AbstractRuleNode})
