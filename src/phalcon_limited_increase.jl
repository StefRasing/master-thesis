abstract type AbstractPhalconLimitedIncrease <: ProgramIterator end
...
@programiterator mutable PhalconLimitedIncrease(
    problem = nothing,
...
) <: AbstractPhalconLimitedIncrease

function heuristic_cost(iter::PhalconLimitedIncrease, program::AbstractRuleNode)::Number
...
"""
function add_to_pool!(iter::PhalconLimitedIncrease, program::AbstractRuleNode, parent=nothing)    
...
"""
function initialize!(iter::PhalconLimitedIncrease)
    # ---------------------------
    #   1. Setup fields
    # ---------------------------
...
function neighborhood(iter::PhalconLimitedIncrease, program::AbstractRuleNode)
    grammar = iter.solver.grammar
    types = grammar.types
...
"""
function combine!(iter::PhalconLimitedIncrease)
...
function refine_heuristic!(iter::PhalconLimitedIncrease)
...
"""
function Base.iterate(iter::PhalconLimitedIncrease)
    initialize!(iter)
...
"""
function Base.iterate(iter::PhalconLimitedIncrease, state::Vector{<:AbstractRuleNode})
