...
include("../src/alt_property_synthesizer.jl")
...
run = "1"
path =          "data/transferable_phalcon_strings/transferable_phalcon_strings_alt.json"
property_path = "data/transferable_phalcon_strings/properties/properties_alt.jld2"
store = true
...
unsolved_tasks = ["problem_39060015", "problem_strip_numeric_characters_from_cell", "problem_get_last_name_from_name_with_comma", "problem_phone_10", "problem_30732554"]
...
for (problem, grammar) in zip(problems, grammars)
    ...
    problem.name in unsolved_tasks && continue
