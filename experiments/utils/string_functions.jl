...
function _interpret_sygus(prog::AbstractRuleNode, grammar_tags::Dict{Int,Any}, args::Dict{Symbol,Any})        
        ...
        MLStyle.@match grammar_tags[r] begin
                ...
                :_arg_out_target => args[:_arg_out_target]

                :_arg_ntString => args[:_arg_ntString]
                :_arg_ntInt    => args[:_arg_ntInt]
                :_arg_ntBool   => args[:_arg_ntBool]
                :_arg_ntStart  => args[:_arg_ntStart]
